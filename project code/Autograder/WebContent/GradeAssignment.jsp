...
<br/>
<form action="/Autograder/GradeAllServlet">
<input type="hidden" name="aid" value="<%=aid%>" />  
  <h1>Assignment Table</h1>
  <div>	
			<input class="style-button-submit"onmouseover="style-button:hover" type="submit" autocomplete="off" value="Grade All"/>
  </div>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      %>
        <tr>
          ...
          <td ><%= ob.getStatus() %></td>
         <%
        	if(ob.getStatus().equals("Submitted"))
        	{	
         %>
          <td align="center"><%= ob.getDateOfUpload() %></td>
          <td align="center"><%= ob.getRating() %></td>
          <td align="center">-</td>
          <td align="center">-</td>
          <%
        	}
        	else if(ob.getStatus().equals("Not Yet Graded"))
        	{
          %>
          <td align="center"><%= ob.getDateOfUpload() %></td>
          <td align="center"><%= ob.getRating() %></td>
